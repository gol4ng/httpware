...
func TestNewAuthenticateFunc(t *testing.T) {
	...
	authenticator.On("Authenticate", context.Background(), "my_credential").Return("my_authenticate_credential", nil)
...
func TestNewAuthenticateFunc_WithCredentialFinder(t *testing.T) {
	...
	authenticator := &mocks.Authenticator{}
	authenticator.On("Authenticate", context.Background(), "my_credential_finder_value").Return("my_authenticate_credential", nil)
...
func TestNewAuthenticateFunc_Error(t *testing.T) {
	...
	authenticator := &mocks.Authenticator{}
	authenticator.On("Authenticate", context.Background(), "my_credential").Return("my_authenticate_credential", err)
